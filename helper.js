      ...
      <tr data-id="${subject._id}">
        ...
        <td>
          <div class="d-flex justify-content-center align-items-center gap-1">
            ...
            <a class="badge btn-primary text-decoration-none" href="/subjects/${subject._id}/chapters"><i class="bi bi-plus-lg"></i> Chapter</a>
            <button type="submit" class="badge bg-danger border-0 deleteSubjectBtn" data-url="/api/subjects/${subject._id}"><i class="bi bi-trash3-fill"></i></button>
          </div>
        </td>
      </tr>
    `;
